...
import hurufS from '../../asset/huruf s.jpeg'; 
import hurufT from '../../asset/huruf t.jpeg'; 
import HomeIcon from './HomeIcon';

const ModuleAlfabet10 = () => {
    return (
        <div id="bg" className="w-full h-screen flex flex-col items-start px-10 lg:px-[72px] pt-[100px]">
          ...
          <div className="p-2 lg:pt-3 mt-2 w-full flex flex-col lg:flex-row">
            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-center items-center mb-8 lg:mb-0 text-center">
              ...
              />
              <h2 className="font-bold text-navy text-4xl mt-2">S</h2> 
              <p className="text-lg text-navy mt-2">
                Huruf S dilakukan dengan mengepalkan tangan dan sandarkan jempol di atas jari-jari lainnya.
                <br /><br /> 
              </p>
            </div>
            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-center items-center mb-8 lg:mb-0 text-center">
              <img
                ...
                style={{ width: '280px', height: '210px' }}
              />
              <h2 className="font-bold text-navy text-4xl mt-2">T</h2> 
              <p className="text-lg text-navy mt-2">
                Huruf T dilakukan dengan mengepalkan tangan dan selipkan jari jempol di antara pangkal jari telunjuk dan tengah. <br /><br /> 
              </p>
            </div>
          </div>
...
export default ModuleAlfabet10;