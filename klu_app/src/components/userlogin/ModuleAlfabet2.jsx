          ...
          <div className="p-2 lg:pt-3 mt-2 w-full flex flex-col lg:flex-row">
            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-center items-center mb-8 lg:mb-0 text-center">
              ...
              <p className="text-lg text-navy mt-2">
                Huruf C dilakukan dengan melengkungkan telapak tangan sehingga bentuknya seperti huruf C terbalik. <br /><br /> 
              </p>
            </div>
            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-center items-center mb-8 lg:mb-0 text-center">
              ...
              <p className="text-lg text-navy mt-2">
              Huruf D dilakukan dengan menyentuhkan jempol pada ujung semua jari, kecuali jari telunjuk yang menunjuk lurus ke atas.<br /><br /> 
              </p>
            </div>
          </div>
