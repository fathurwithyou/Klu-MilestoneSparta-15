  ...
  return (
    <div id="bg" className="w-full h-screen flex flex-col items-start lg:px-[32px] pt-[100px]">
      <div className="w-full flex justify-start items-start mb-8">
        <h1 className="font-bold text-navy text-5xl mt-12 ml-0">Module Video Angka</h1>
      </div>
      
      <div className="w-full max-w-2xl mb-8 mx-auto">
        <ReactPlayer
          ref={playerRef}
          url="https://youtu.be/LAToHOBd1KM?si=zurlAuaYRX1zojol"
...
export default ModuleVideoAngka;