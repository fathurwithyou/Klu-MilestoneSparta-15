      ...
      <div className="p-2 lg:pt-3 mt-2 w-full flex flex-col lg:flex-row">
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center items-center mb-8 lg:mb-0 text-center">
          ...
          <p className="text-lg text-navy mt-2">
            Huruf K dilakukan dengan meluruskan jari tengah dan telunjuk mengarah ke atas, dan letakkan jempol di buku jari
            pertama jari tengah. <br />
            <br />
          </p>
        </div>
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center items-center mb-8 lg:mb-0 text-center">
          ...
          <p className="text-lg text-navy mt-2">
            Huruf L dilakukan dengan membuat huruf L dengan jempol dan jari telunjuk. <br />
            <br />
          </p>
        </div>
      </div>
