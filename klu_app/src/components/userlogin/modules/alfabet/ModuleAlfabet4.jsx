      ...
      <div className="p-2 lg:pt-3 mt-2 w-full flex flex-col lg:flex-row">
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center items-center mb-8 lg:mb-0 text-center">
          ...
          <p className="text-lg text-navy mt-2">
            Huruf G dilakukan dengan meluruskan jari jempol dan telunjuk serta beri jarak sekitar 1 cm, lalu tunjukkan secara
            menyamping selagi telapak tangan menghadap Anda. <br />
            <br />
          </p>
        </div>
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center items-center mb-8 lg:mb-0 text-center">
          ...
          <p className="text-lg text-navy mt-2">
            Huruf H dilakukan dengan membuat isyarat abjad G dan luruskan jari tengah rapat dengan jari telunjuk, lalu telapak
            tangan menghadap ke arah Anda. <br />
            <br />
          </p>
        </div>
      </div>
